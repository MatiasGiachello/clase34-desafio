...
router.get('/crearProducto', auth, async (req, res) => {
    ...
    res.setHeader('Content-Type', 'text/html');
    if (error) {
        res.status(400).render('crearProducto', { error, errorDetail, typeofuser, mostrarMenu0, mostrarMenu1, mostrarMenu2, mostrarMenu3, mostrarMenu4, mostrarMenu5, mostrarMenu6, mostrarMenu7, mostrarMenu8, mostrarMenu9 });
    } else {
        {
...
router.get('/modificarProductos', auth, async (req, res) => {
    ...
    res.setHeader('Content-Type', 'text/html');
    if (error) {
        res.status(400).render('modificarProductos', { renderedProducts, error, errorDetail, typeofuser, mostrarMenu0, mostrarMenu1, mostrarMenu2, mostrarMenu3, mostrarMenu4, mostrarMenu5, mostrarMenu6, mostrarMenu7, mostrarMenu8, mostrarMenu9 });
    } else {
        {
...
router.get('/borrarProductos', auth, async (req, res) => {
    ...
    res.setHeader('Content-Type', 'text/html');
    if (error) {
        res.status(400).render('borrarProductos', { renderedProducts, error, errorDetail, typeofuser, mostrarMenu0, mostrarMenu1, mostrarMenu2, mostrarMenu3, mostrarMenu4, mostrarMenu5, mostrarMenu6, mostrarMenu7, mostrarMenu8, mostrarMenu9 });
    } else {
        {
